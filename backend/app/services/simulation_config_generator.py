...
- reasoning (string): 简要说明为什么这样配置"""
        ...
        system_prompt = "你是个人人生模拟专家。返回绯JSON格式，时间配置需符合个人生活节奏与工作作息习惯。"
...
{{
    ...
    "reasoning": "<简要说明>"
        ...
        system_prompt = "你是个人决策路径分析专家。返回绯JSON格式。注意 poster_type 必须精确匹配可用实体类型。"
...
{{
    "agent_configs": [
        ...
        system_prompt = "你是个人人生行为分析专家。返回绯JSON，配置需符合个人生活节奏与日常作息习惯。"
